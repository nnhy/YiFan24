...
public class BinaryTree
{
    ...
    public String[] Execute(Double[] numbers, Double result)
    {
        ...
        var operators = new List<Func<Expression, Expression, Expression>> {
            Expression.Add,
            Expression.Subtract,
            Expression.Multiply,
            Expression.Divide,};

        if (Operations.Contains("Modulo"))
            operators.Add(Expression.Modulo);
        if (Operations.Contains("Power"))
            operators.Add(Expression.Power);
